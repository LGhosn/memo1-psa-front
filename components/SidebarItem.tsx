  ...
  if (children && children.length > 0) {
    return (
      <li className="m-2">
        <button
          type="button"
          className="flex items-center w-full p-2 text-grey-200 transition duration-75 rounded-lg group hover:bg-blue-100 dark:text-white dark:hover:bg-amber-700"
