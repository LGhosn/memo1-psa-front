...
export function TaskTicketCreationForm({ title, setOpenForm, ticketId }: PropsForm) {
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div className="mt-2">
                    <div>
                      ...
                      <div className="mt-1">
                        <input name="name" id="name" className=" p-2 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-black-600 block w-full sm:text-sm border-gray-300 rounded-md text-gray-900"></input>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <textarea name="description" id="description" className=" p-2 min-h-fit h-40 max-h-60 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-black-600 block w-full sm:text-sm border-gray-300 rounded-md text-gray-900"></textarea>
                      </div>
                    </div>
