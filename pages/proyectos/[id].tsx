  ...
  return (
    ...
    <>
     ...
     <div className="flex flex-col border-4 border-gray-500 w-full h-11/12 mt-5" >
       ...
       <h1 className="text-6xl mb-5 font-bold"  id="name"style={{textAlign:'center', marginTop:"20px"}}></h1>

       <div className="ml-10 mt-3 flex flex-row">
          <h2 className="font-bold" style={{fontSize: '1.3rem'}}>ID:</h2>
          <div className="ml-2 mt-1 flex items-center text-gray-900" style={{fontSize: '1.2rem'}}>
          {id}
          </div>
        </div>
